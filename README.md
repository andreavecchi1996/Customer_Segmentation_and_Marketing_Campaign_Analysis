...
In this project, I performed an end-to-end analysis of a customer marketing dataset sourced from Kaggle. The objective was to explore customer profiles, analyse purchasing behaviour, and evaluate the effectiveness of past marketing campaigns. I used SQL for data cleaning, transformation, and exploratory queries, focusing on customer segmentation based on age, income, family composition, and spending patterns.
